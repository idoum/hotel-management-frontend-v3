 ...
 * @description Header: brand, login, profile menu (me, change password, logout).
 */
  ...
  return (
    <nav className="navbar navbar-expand-lg bg-body-tertiary">
      <div className="container">
        <Link className="navbar-brand fw-bold" href="/">Hotel Management</Link>
          ...
          {session.user && (
            <div className="dropdown">
              ...
              <ul className="dropdown-menu dropdown-menu-end">
                ...
                <li><Link className="dropdown-item" href="/me/password">Changer le mot de passe</Link></li>
                <li><button className="dropdown-item" onClick={() => logout()}>Deconnexion</button></li>
              </ul>
            </div>
          )}
        </div>
